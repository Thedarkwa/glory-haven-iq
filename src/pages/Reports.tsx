import { payments, expenses, payroll } from "@/data/mockData";
...
const netBalance = totalIncome - totalExpenses - totalPayroll;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Total Expenses" value={`₵${totalExpenses.toLocaleString()}`} icon={Receipt} />
